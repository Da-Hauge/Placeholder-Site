...
| Mailanbieter für `maximilian@haug-it.eu` | Empfang und Speicherung eingehender E-Mails | E-Mail-Adresse, Name, Nachrichteninhalt | **unbekannt** | **offen** | **offen — bitte ergänzen** |
...
Bis diese drei Punkte beantwortet sind, ist Abschnitt 4 der
`datenschutz.html` unvollständig.
...
**Mailanbieter.** Der Anbieter des Postfachs hinter `maximilian@haug-it.eu` ist
hier noch nicht eingetragen. Ergänzen, sobald bekannt: Anbieter, Serverstandort,
AVV-Status, Aufbewahrungsdauer. Liegt der Anbieter außerhalb der EU/des EWR,
gilt dieselbe Prüfung wie oben.
